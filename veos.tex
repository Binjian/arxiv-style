...
%\usepackage{import}
\graphicspath{{images/}}
\title{Vehicle energy optimization system - an application of deep reinforcement learning with human in the loop}
...
\begin{figure}[ht]
  ...
  \input{images/test_excalidraw.pdf_tex}
  \caption{\label{fig:label} test excalidraw export image}
\end{figure}
